    ...
    public productsearch() {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        	...
        	DBConnection dbConnection = new DBConnection(dbUrl, username, password);
                        ...
                        {	
	                        out.println("<h2>Enter the correct product ID</h2>");
	                        out.println("<br><a href=\"productsearch.html\">Back to search page</a>");
                        }
                        ...
                        else 
                        {
                    		...
                    		out.print("</table>");
                            	...
                            	out.println("There was no element with product ID: " + productSearch + " found in the table <br/> please try again");
                            out.println("<br><a href=\"productsearch.html\">Back to search page</a>");
                            }
                        }
